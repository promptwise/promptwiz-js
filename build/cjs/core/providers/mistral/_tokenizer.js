...
__export(tokenizer_exports, {
  MistralTiktoken: () => MistralTiktoken
});
module.exports = __toCommonJS(tokenizer_exports);
var import_utils = require("../../utils");
var import_encodings = require("./_encodings");
...
class MistralTiktoken {
  constructor(options) {
    ...
    this.vocabById = decodeVocabulary(import_encodings.vocab_base64);
    ...
    this.merges = this.decompressMerges(import_encodings.merges_binary);
  }
  ...
  encode(prompt, preserve_templates = false) {
    ...
    if (!preserve_templates) {
      prompt = prompt.replaceAll(import_utils.template_regex, "");
    }
